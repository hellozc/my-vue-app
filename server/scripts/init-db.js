...
async function main() {
  ...
  console.log(`[DB] 数据库 ${config.db.database} 已就绪`)
  ...
  if (roleMenuCountRows[0].total === 0) {
    ...
    console.log('[DB] 角色菜单权限已存在，跳过导入')
    // 为超级管理员补全新增菜单权限（不影响其他角色）
